...
const Contact = () => (
  <Layout>
    <div className='about'>
      ...
      <a href='https://www.linkedin.com/in/jeff-walsh-1445414a/' target="_blank">
        <button type='button' className='btn btn-primary'>
          Linkedin{' '}
          <span className='badge badge-light'> jeff-walsh-1445414a </span>
        </button>
      </a>
      <a href='https://github.com/jeffpwalsh' target="_blank">
        <button type='button' className='btn btn-warning'>
          GitHub{' '}
          <span className='badge badge-light'> https://github.com/jeffpwalsh </span>
        </button>
      </a>
    </div>
    {/* LOCAL STYLED JSX */}
